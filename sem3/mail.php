...
<div id="listData" class="list-form-container">
    <?php
        ...
        $connection = imap_open('{imap.gmail.com:993/imap/ssl}INBOX', 'smanishmaitvec@gmail.com', 'sdmv2000') or die('Cannot connect to Gmail: ' . imap_last_error());
 
        /* Search Emails having the specified keyword in the email subject */
        $emailData = imap_search($connection, 'FROM "Manishma S "');
         rsort($emailData);
        if (! empty($emailData)) {
            ?>
    <table>
